...
# --- CORS: required so a website on a different domain (e.g. your Vercel site)
# is allowed by the browser to call this API. Without this, every request
...
def run_insurance(request: RevenueRenewal):
    try:
        ...
        data = pd.DataFrame(data, columns=['perc_premium_paid_by_cash_credit', 'age_in_days', 'Income',
            ...
            'application_underwriting_score', 'no_of_premiums_paid', 'sourcing_channel', 'residence_area_type', 'premium'])
